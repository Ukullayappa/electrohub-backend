...
// Connect to database (same logic as pool.js)
...
async function seed() {
  ...
  try {
    ...
    // SEED USERS
    // bcrypt.hash(password, 10) — the 10 means "how hard to crack" (higher = safer but slower)
    ...
    const products = [
      ...
      },
      {
        ...
        desc:"The ultimate Galaxy with built-in S Pen, 200MP camera, and Galaxy AI.",
      ...
      },
      {
        ...
        desc:"Hasselblad camera, Snapdragon 8 Gen 3, and 100W SUPERVOOC charging.",
      ...
      /* ── Laptops ── */
      {
        ...
        desc:"Supercharged by M3 Max. Up to 128GB unified memory, Liquid Retina XDR, all-day battery.",
        ...
        specs:{Display:"16.2-inch Liquid Retina XDR",Chip:"Apple M3 Max",RAM:"36GB Unified",Storage:"1TB SSD",Battery:"Up to 22hr",GPU:"40-core GPU"},
        features:["M3 Max chip","Liquid Retina XDR","ProMotion 120Hz","MagSafe charging","22 hours battery","8K HDMI output"],
      ...
      },
      {
        ...
        desc:"Stunning OLED display, Intel Core i9, NVIDIA RTX 4070.",
      ...
      },
      {
        ...
        features:["AniMe Matrix LED","MUX switch","165Hz QHD+","USB4","Wi-Fi 6E"],
      ...
      },
      {
        ...
        desc:"2x more Active Noise Cancellation, Adaptive Transparency, Personalized Spatial Audio.",
      ...
      },
      {
        ...
        desc:"World-class noise cancellation. Up to 24 hours of battery life.",
      ...
      },
      {
        ...
        desc:"Rotating bezel, ECG, blood pressure, body composition. Wear OS 4.",
      ...
      /* ── Gaming ── */
      {
        ...
        desc:"Custom CPU, GPU and SSD. Haptic feedback, 3D Audio, up to 8K.",
    ...
    // CREATE TRIGGER: auto-update product rating when a review is added
    await client.query(`
